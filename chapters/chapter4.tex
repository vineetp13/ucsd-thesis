...
%These results highlight the promise of performing personally  meaningful scientific work using massive online learning
%systems.
\end{quote}
...
{The Learn-Train-Ask workflow enables novices to ask useful questions collaborate with online peers\index{docent-0}}
  \label{fig:docent-0}
\end{figure}
...
%%%%%%%%%%%%%
\section{Can People be Scientists Rather than Just Sensors?}
...
%\begin{wrapfigure}{r}{0.5\textwidth}
%  \centering
%  \includegraphics[width=0.5\textwidth]{figures/docent/fig-5.png}
%  \caption[Training improved the overall question quality but learning did not]
%{Training improved the overall question quality (p <.05) but learning did not (p $<$ 0.1). H1: Training marginally improved question structure (p <.06). H2: Learning improved question content (p <.05).\index{docent-5}}
%  \label{fig:docent-5}
%\end{wrapfigure}
